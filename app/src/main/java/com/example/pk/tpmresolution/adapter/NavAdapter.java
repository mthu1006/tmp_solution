...
public class NavAdapter extends RecyclerView.Adapter<NavAdapter.MyViewHolder> {
    ...
    private List<NavigationItem> mListEmail;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            name = (CustomFontTextView) view.findViewById(R.id.textTitle);
    ...
    public NavAdapter(Context context, List<NavigationItem> moviesList, NavigationClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_navigation, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        NavigationItem menu = mListEmail.get(position);
